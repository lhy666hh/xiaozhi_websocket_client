...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_1_label_1, "OK");
    lv_label_set_long_mode(ui->screen_1_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_1_label_1, 75, 40);
    ...
    lv_obj_set_style_text_font(ui->screen_1_label_1, &myfont, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_btn_1, 96, 187);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_1, &myfont, LV_PART_MAIN|LV_STATE_DEFAULT);
